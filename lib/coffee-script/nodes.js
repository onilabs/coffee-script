(function() {
  var Access, AltPar, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Suspend, Switch, TAB, THIS, Throw, Try, TryTail, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.Try = Try = (function() {
    __extends(Try, Base);
    function Try(attempt, tail) {
      this.attempt = attempt;
      this.tail = tail;
    }
    Try.prototype.children = ['attempt', 'tail'];
    Try.prototype.isStatement = YES;
    Try.prototype.jumps = function(o) {
      var _ref2;
      return this.attempt.jumps(o) || ((_ref2 = this.tail) != null ? _ref2.jumps(o) : void 0);
    };
    Try.prototype.makeReturn = function(res) {
      if (this.attempt) this.attempt = this.attempt.makeReturn(res);
      if (this.tail) this.tail = this.tail.makeReturn(res);
      return this;
    };
    Try.prototype.compileNode = function(o) {
      ...
      if (this.tail) {
        o.indent = ind;
        code += this.tail.compile(o, LEVEL_TOP);
      } else {
        code += " catch (_e) {}";
      }
      return code;
  ...
  exports.TryTail = TryTail = (function() {
    __extends(TryTail, Base);
    function TryTail(error, _catch, _retract, _finally) {
      this.error = error;
      this._catch = _catch;
      this._retract = _retract;
      this._finally = _finally;
    }
    TryTail.prototype.children = ['_catch', '_retract', '_finally'];
    TryTail.prototype.jumps = function(o) {
      var _ref2, _ref3;
      return ((_ref2 = this._catch) != null ? _ref2.jumps(o) : void 0) || ((_ref3 = this._retract) != null ? _ref3.jumps(o) : void 0);
    };
    TryTail.prototype.makeReturn = function(res) {
      if (this._catch) this._catch = this._catch.makeReturn(res);
      if (this._retract) this._retract = this._retract.makeReturn(res);
      return this;
    };
    TryTail.prototype.compileNode = function(o) {
      var code;
      o.indent += TAB;
      code = "";
      if (this._catch) {
        o.scope.add(this.error.value, 'param');
        code += "\n" + this.tab + "catch (" + (this.error.compile(o)) + ") {\n" + (this._catch.compile(o, LEVEL_TOP)) + "\n" + this.tab + "}";
      }
      if (this._retract) {
        code += "\n" + this.tab + "retract {\n" + (this._retract.compile(o, LEVEL_TOP)) + "\n" + this.tab + "}";
      }
      if (this._finally) {
        code += "\n" + this.tab + "finally {\n" + (this._finally.compile(o, LEVEL_TOP)) + "\n" + this.tab + "}";
      }
      return code;
    };
    return TryTail;
  })();
  exports.AltPar = AltPar = (function() {
    __extends(AltPar, Base);
    function AltPar(combinator, blocks, tail) {
      this.combinator = combinator;
      this.blocks = blocks;
      this.tail = tail;
    }
    AltPar.prototype.children = ['blocks', 'tail'];
    AltPar.prototype.isStatement = YES;
    AltPar.prototype.jumps = function(o) {
      var block, _i, _len, _ref2, _ref3;
      _ref2 = this.blocks;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        block = _ref2[_i];
        if (block.jumps(o)) return block;
      }
      return (_ref3 = this.tail) != null ? _ref3.jumps(o) : void 0;
    };
    AltPar.prototype.makeReturn = function(res) {
      var block;
      if (this.combinator === 'or') {
        this.blocks = (function() {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            block = _ref2[_i];
            _results.push(block.makeReturn(res));
          }
          return _results;
        }).call(this);
        if (this.tail) this.tail = this.tail.makeReturn(res);
    ...
    AltPar.prototype.compileNode = function(o) {
      var block, code, ind;
      ind = o.indent;
      o.indent += TAB;
      code = "" + this.tab + "waitfor ";
      code += ((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.blocks;
        _results = [];
  ...
  exports.Suspend = Suspend = (function() {
    __extends(Suspend, Base);
    function Suspend(rv, block, tail) {
      this.rv = rv;
      this.block = block;
      this.tail = tail;
    }
    Suspend.prototype.children = ['block', 'tail'];
    Suspend.prototype.isStatement = YES;
    Suspend.prototype.jumps = function(o) {
      var _ref2;
      return this.block.jumps(o) || ((_ref2 = this.tail) != null ? _ref2.jumps(o) : void 0);
    };
    Suspend.prototype.makeReturn = function(res) {
      this.block = block.makeReturn(res);
      if (this.tail) this.tail = this.tail.makeReturn(res);
      return this;
    };
    Suspend.prototype.compileNode = function(o) {
      var code, ind, name;
      ind = o.indent;
      o.indent += TAB;
      code = "" + this.tab + "waitfor (";
      if (this.rv) {
        name = this.rv.compile(o);
        o.scope.add(name, 'var');
        code += name;
      }
      code += ") {\n" + (this.block.compile(o, LEVEL_TOP)) + "\n" + this.tab + "}";
      if (this.tail) {
        o.indent = ind;
        code += this.tail.compile(o, LEVEL_TOP);
      }
