(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.ensureBalance = function(pairs) {
      var close, level, levels, open, openLine, tag, token, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
      levels = {};
      openLine = {};
      _ref = this.tokens;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = pairs.length; _j < _len2; _j++) {
          ...
          if (tag === open) {
            ...
            throw Error("too many " + ((_ref3 = token[1]) != null ? _ref3 : "") + " on line " + ((_ref4 = token[2] + 1) != null ? _ref4 : ""));
          }
        }
      }
      for (open in levels) {
        level = levels[open];
        if (level > 0) {
          throw Error("unclosed " + ((_ref5 = open) != null ? _ref5 : "") + " on line " + ((_ref6 = openLine[open] + 1) != null ? _ref6 : ""));
        }
      }
      return this;
    };
