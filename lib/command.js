(function() {
    ...
    for (_i = 0, _len = sources.length; _i < _len; _i++) {
      ...
      compile = function(source, sourceIndex, topLevel) {
        return path.exists(source, function(exists) {
          if (topLevel && !exists) {
            throw new Error("File not found: " + (source != null ? source : ""));
          }
  ...
  writeJs = function(source, js, base) {
    ...
    compile = function() {
      ...
      return fs.writeFile(jsPath, js, function(err) {
        ...
        if (err) {
          ...
          return console.log("" + ((_ref2 = (new Date).toLocaleTimeString()) != null ? _ref2 : "") + " - compiled " + (source != null ? source : ""));
        }
      });
    };
    return path.exists(dir, function(exists) {
      if (exists) {
        ...
        return exec("mkdir -p " + (dir != null ? dir : ""), compile);
      }
    });
  };
  ...
  printTokens = function(tokens) {
    ...
    strings = (function() {
      ...
      for (_i = 0, _len = tokens.length; _i < _len; _i++) {
        ...
        _results.push("[" + (tag != null ? tag : "") + " " + (value != null ? value : "") + "]");
      }
      return _results;
    })();
  ...
  version = function() {
    var _ref2;
    return printLine("CoffeeScript version " + ((_ref2 = CoffeeScript.VERSION) != null ? _ref2 : ""));
  };
}).call(this);
