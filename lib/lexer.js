(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.heregexToken = function(match) {
      var body, flags, heregex, re, tag, tokens, value, _i, _len, _ref2, _ref3, _ref4, _ref5, _ref6;
      heregex = match[0], body = match[1], flags = match[2];
      if (0 > body.indexOf('#{')) {
        re = body.replace(HEREGEX_OMIT, '').replace(/\//g, '\\/');
        this.token('REGEX', "/" + ((_ref2 = re || '(?:)') != null ? _ref2 : "") + "/" + (flags != null ? flags : ""));
    ...
    Lexer.prototype.sanitizeHeredoc = function(doc, options) {
      var attempt, herecomment, indent, match, _ref2, _ref3;
      indent = options.indent, herecomment = options.herecomment;
      if (herecomment) {
        if (HEREDOC_ILLEGAL.test(doc)) {
          throw new Error("block comment cannot contain \"*/\", starting on line " + ((_ref2 = this.line + 1) != null ? _ref2 : ""));
        }
        if (doc.indexOf('\n') <= 0) {
          return doc;
        }
    ...
    Lexer.prototype.identifierError = function(word) {
      var _ref2;
      throw SyntaxError("Reserved word \"" + (word != null ? word : "") + "\" on line " + ((_ref2 = this.line + 1) != null ? _ref2 : ""));
    };
    Lexer.prototype.assignmentError = function() {
      var _ref2, _ref3;
      throw SyntaxError("Reserved word \"" + ((_ref2 = this.value()) != null ? _ref2 : "") + "\" on line " + ((_ref3 = this.line + 1) != null ? _ref3 : "") + " can't be assigned");
    };
    Lexer.prototype.balancedString = function(str, end) {
      var i, letter, prev, stack, _ref2, _ref3, _ref4;
      stack = [end];
      ...
      throw new Error("missing " + ((_ref3 = stack.pop()) != null ? _ref3 : "") + ", starting on line " + ((_ref4 = this.line + 1) != null ? _ref4 : ""));
    };
