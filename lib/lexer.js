  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.heregexToken = function(match) {
      ...
      if (0 > body.indexOf('#{')) {
        ...
        this.token('REGEX', ["/", re || '(?:)', "/", flags].join(""));
    ...
    Lexer.prototype.sanitizeHeredoc = function(doc, options) {
      ...
      if (herecomment) {
        if (HEREDOC_ILLEGAL.test(doc)) {
          throw new Error(["block comment cannot contain \"*/\", starting on line ", this.line + 1].join(""));
        }
        if (doc.indexOf('\n') <= 0) {
          return doc;
        }
    ...
    Lexer.prototype.identifierError = function(word) {
      throw SyntaxError(["Reserved word \"", word, "\" on line ", this.line + 1].join(""));
    };
    Lexer.prototype.assignmentError = function() {
      throw SyntaxError(["Reserved word \"", this.value(), "\" on line ", this.line + 1, " can't be assigned"].join(""));
    };
    Lexer.prototype.balancedString = function(str, end) {
      ...
      throw new Error(["missing ", stack.pop(), ", starting on line ", this.line + 1].join(""));
    };
