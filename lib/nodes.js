(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileLoopReference = function(o, name) {
      ...
      if (!((-Infinity < +src && +src < Infinity) || IDENTIFIER.test(src) && o.scope.check(src, true))) {
        src = ["", (tmp = o.scope.freeVariable(name)), " = ", src].join("");
      }
      return [src, tmp];
    };
  ...
  exports.Literal = Literal = (function() {
    ...
    Literal.prototype.compileNode = function(o) {
      var code;
      code = this.isUndefined ? o.level >= LEVEL_ACCESS ? '(void 0)' : 'void 0' : this.value.reserved ? ["\"", this.value, "\""].join("") : this.value;
      if (this.isStatement()) {
        return ["", this.tab, code, ";"].join("");
      } else {
        return code;
      }
    };
  ...
  exports.Return = Return = (function() {
    ...
    Return.prototype.compileNode = function(o) {
      return this.tab + ["return", (this.expression ? ' ' + this.expression.compile(o, LEVEL_PAREN) : ''), ";"].join("");
    };
    return Return;
  })();
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.superReference = function(o) {
      ...
      if (method.klass) {
        ...
        return ["", name, ".__super__.constructor"].join("");
      }
    };
    Call.prototype.unfoldSoak = function(o) {
      ...
      if (this.soak) {
        ...
        left = new Literal(["typeof ", left.compile(o), " === \"function\""].join(""));
    ...
    Call.prototype.compileNode = function(o) {
      ...
      if (this.isSuper) {
        return this.superReference(o) + [".call(this", args && ', ' + args, ")"].join("");
      } else {
        return (this.isNew ? 'new ' : '') + this.variable.compile(o, LEVEL_ACCESS) + ["(", args, ")"].join("");
      }
    };
    Call.prototype.compileSuper = function(args, o) {
      return ["", this.superReference(o), ".call(this", (args.length ? ', ' : ''), args, ")"].join("");
    };
    Call.prototype.compileSplat = function(o, splatArgs) {
      var base, fun, idt, name, ref;
      if (this.isSuper) {
        return ["", this.superReference(o), ".apply(this, ", splatArgs, ")"].join("");
      }
      if (this.isNew) {
        idt = this.tab + TAB;
        return ["(function(func, args, ctor) {\n", idt, "ctor.prototype = func.prototype;\n", idt, "var child = new ctor, result = func.apply(child, args);\n", idt, "return typeof result === \"object\" ? result : child;\n", this.tab, "})(", this.variable.compile(o, LEVEL_LIST), ", ", splatArgs, ", function() {})"].join("");
      }
      base = new Value(this.variable);
      if ((name = base.properties.pop()) && base.isComplex()) {
        ref = o.scope.freeVariable('ref');
        fun = ["(", ref, " = ", base.compile(o, LEVEL_LIST), ")", name.compile(o)].join("");
      } else {
      ...
      return ["", fun, ".apply(", ref, ", ", splatArgs, ")"].join("");
    };
    return Call;
  })();
  ...
  exports.Access = Access = (function() {
    ...
    Access.prototype.compile = function(o) {
      ...
      return this.proto + (IDENTIFIER.test(name) ? [".", name].join("") : ["[", name, "]"].join(""));
    };
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile = function(o) {
      return (this.proto ? '.prototype' : '') + ["[", this.index.compile(o, LEVEL_PAREN), "]"].join("");
    };
  ...
  exports.Range = Range = (function() {
    ...
    Range.prototype.compileNode = function(o) {
      ...
      idx = del(o, 'index');
      varPart = ["", idx, " = ", this.from].join("");
      if (this.to !== this.toVar) {
        varPart += [", ", this.to].join("");
      }
      if (this.step !== this.stepVar) {
        varPart += [", ", this.step].join("");
      }
      _ref2 = [["", idx, " <", this.equals].join(""), ["", idx, " >", this.equals].join("")], lt = _ref2[0], gt = _ref2[1];
      condPart = this.stepNum ? condPart = +this.stepNum > 0 ? ["", lt, " ", this.toVar].join("") : ["", gt, " ", this.toVar].join("") : known ? ((_ref3 = [+this.fromNum, +this.toNum], from = _ref3[0], to = _ref3[1], _ref3), condPart = from <= to ? ["", lt, " ", to].join("") : ["", gt, " ", to].join("")) : (cond = ["", this.fromVar, " <= ", this.toVar].join(""), condPart = ["", cond, " ? ", lt, " ", this.toVar, " : ", gt, " ", this.toVar].join(""));
      stepPart = this.stepVar ? ["", idx, " += ", this.stepVar].join("") : known ? from <= to ? ["", idx, "++"].join("") : ["", idx, "--"].join("") : ["", cond, " ? ", idx, "++ : ", idx, "--"].join("");
      return ["", varPart, "; ", condPart, "; ", stepPart].join("");
    };
    Range.prototype.compileArray = function(o) {
      ...
      if (this.fromNum && this.toNum) {
        ...
        vars = ["", i, " = ", this.from].join("") + (this.to !== this.toVar ? [", ", this.to].join("") : '');
        cond = ["", this.fromVar, " <= ", this.toVar].join("");
        body = ["var ", vars, "; ", cond, " ? ", i, " <", this.equals, " ", this.toVar, " : ", i, " >", this.equals, " ", this.toVar, "; ", cond, " ? ", i, "++ : ", i, "--"].join("");
      }
      post = ["{ ", result, ".push(", i, "); }\n", idt, "return ", result, ";\n", o.indent].join("");
      return ["(function() {", pre, "\n", idt, "for (", body, ")", post, "}).apply(this, arguments)"].join("");
    };
    return Range;
  })();
  exports.Slice = Slice = (function() {
    ...
    Slice.prototype.compileNode = function(o) {
      ...
      if (to && !(!this.range.exclusive && +compiled === -1)) {
        toStr = ', ' + (this.range.exclusive ? compiled : SIMPLENUM.test(compiled) ? (+compiled + 1).toString() : ["(", compiled, " + 1) || 9e9"].join(""));
      }
      return [".slice(", fromStr, toStr || '', ")"].join("");
    };
    return Slice;
  })();
  ...
  exports.Class = Class = (function() {
    ...
    Class.prototype.addBoundFunctions = function(o) {
      ...
      if (this.boundFuncs.length) {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ...
          _results.push(this.ctor.body.unshift(new Literal(["", lhs, " = ", utility('bind'), "(", lhs, ", this)"].join(""))));
        }
        return _results;
      }
    };
    ...
    Class.prototype.ensureConstructor = function(name) {
      if (!this.ctor) {
        this.ctor = new Code;
        if (this.parent) {
          this.ctor.body.push(new Literal(["", name, ".__super__.constructor.apply(this, arguments)"].join("")));
        }
        if (this.externalCtor) {
          this.ctor.body.push(new Literal(["", this.externalCtor, ".apply(this, arguments)"].join("")));
        }
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (!(this.context || this.variable.isAssignable())) {
        throw SyntaxError(["\"", this.variable.compile(o), "\" cannot be assigned."].join(""));
      }
      ...
      val = name + [" ", this.context || '=', " "].join("") + val;
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      if (!IDENTIFIER.test(vvar) || this.variable.assigns(vvar)) {
        assigns.push(["", (ref = o.scope.freeVariable('ref')), " = ", vvar].join(""));
        vvar = ref;
      }
      for (i = 0, _len = objects.length; i < _len; i++) {
        ...
        if (!splat && obj instanceof Splat) {
          val = ["", olen, " <= ", vvar, ".length ? ", utility('slice'), ".call(", vvar, ", ", i].join("");
          if (rest = olen - i - 1) {
            ivar = o.scope.freeVariable('i');
            val += [", ", ivar, " = ", vvar, ".length - ", rest, ") : (", ivar, " = ", i, ", [])"].join("");
          } else {
            val += ") : []";
          }
          val = new Literal(val);
          ...
          if (obj instanceof Splat) {
            ...
            throw SyntaxError(["multiple splats are disallowed in an assignment: ", obj, " ..."].join(""));
          }
    ...
    Assign.prototype.compileSplice = function(o) {
      ...
      code = ["[].splice.apply(", name, ", [", fromDecl, ", ", to, "].concat(", valDef, ")), ", valRef].join("");
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (this.bound) {
        return utility('bind') + ["(", code, ", ", this.context, ")"].join("");
      }
  ...
  exports.Splat = Splat = (function() {
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      ...
      if (list.length === 1) {
        ...
        return ["", utility('slice'), ".call(", code, ")"].join("");
      }
      args = list.slice(index);
      for (i = 0, _len = args.length; i < _len; i++) {
        node = args[i];
        code = node.compile(o, LEVEL_LIST);
        args[i] = node instanceof Splat ? ["", utility('slice'), ".call(", code, ")"].join("") : ["[", code, "]"].join("");
      }
      if (index === 0) {
        return args[0] + [".concat(", args.slice(1).join(', '), ")"].join("");
      }
      base = (function() {
      ...
      return ["[", base.join(', '), "].concat(", args.join(', '), ")"].join("");
    };
    return Splat;
  })();
  exports.While = While = (function() {
    ...
    While.prototype.compileNode = function(o) {
      ...
      code = set + this.tab + ["while (", this.condition.compile(o, LEVEL_PAREN), ") {", body, "}"].join("");
      if (this.returns) {
        code += ["\n", this.tab, "return ", rvar, ";"].join("");
      }
      return code;
    };
    return While;
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileChain = function(o) {
      ...
      code = ["", fst, " ", (this.invert ? '&&' : '||'), " ", shared.compile(o), " ", this.operator, " ", this.second.compile(o, LEVEL_OP)].join("");
      return ["(", code, ")"].join("");
    };
  ...
  exports.In = In = (function() {
    ...
    In.prototype.compileLoopTest = function(o) {
      ...
      code = utility('indexOf') + [".call(", this.array.compile(o, LEVEL_LIST), ", ", ref, ") "].join("") + (this.negated ? '< 0' : '>= 0');
      if (sub === ref) {
        return code;
      }
      code = sub + ', ' + code;
  ...
  exports.Try = Try = (function() {
    ...
    Try.prototype.compileNode = function(o) {
      ...
      o.indent += TAB;
      errorPart = this.error ? [" (", this.error.compile(o), ") "].join("") : ' ';
      catchPart = this.recovery ? [" catch", errorPart, "{\n", this.recovery.compile(o, LEVEL_TOP), "\n", this.tab, "}"].join("") : !(this.ensure || this.recovery) ? ' catch (_e) {}' : void 0;
      return ["", this.tab, "try {\n", this.attempt.compile(o, LEVEL_TOP), "\n", this.tab, "}", catchPart || ''].join("") + (this.ensure ? [" finally {\n", this.ensure.compile(o, LEVEL_TOP), "\n", this.tab, "}"].join("") : '');
    };
    return Try;
  })();
  exports.Throw = Throw = (function() {
    ...
    Throw.prototype.compileNode = function(o) {
      return this.tab + ["throw ", this.expression.compile(o), ";"].join("");
    };
    return Throw;
  })();
  exports.Existence = Existence = (function() {
    ...
    Existence.prototype.compileNode = function(o) {
      ...
      code = IDENTIFIER.test(code) && !o.scope.check(code) ? ((_ref2 = this.negated ? ['===', '||'] : ['!==', '&&'], cmp = _ref2[0], cnj = _ref2[1], _ref2), ["typeof ", code, " ", cmp, " \"undefined\" ", cnj, " ", code, " ", cmp, " null"].join("")) : ["", code, " ", (this.negated ? '==' : '!='), " null"].join("");
  ...
  exports.For = For = (function() {
    ...
    For.prototype.compileNode = function(o) {
      ...
      if (this.range) {
        ...
        if (name && !this.pattern) {
          namePart = ["", name, " = ", svar, "[", ivar, "]"].join("");
        }
        if (!this.object) {
          lvar = scope.freeVariable('len');
          forVarPart = ["", ivar, " = 0, ", lvar, " = ", svar, ".length"].join("") + (this.step ? [", ", stepvar, " = ", this.step.compile(o, LEVEL_OP)].join("") : '');
          stepPart = this.step ? ["", ivar, " += ", stepvar].join("") : ["", ivar, "++"].join("");
          forPart = ["", forVarPart, "; ", ivar, " < ", lvar, "; ", stepPart].join("");
        }
      }
      if (this.returns) {
      ...
      if (this.pattern) {
        body.expressions.unshift(new Assign(this.name, new Literal(["", svar, "[", ivar, "]"].join(""))));
      }
      ...
      if (this.object) {
        forPart = ["", ivar, " in ", svar].join("");
        if (this.own) {
          guardPart = ["\n", idt1, "if (!", utility('hasProp'), ".call(", svar, ", ", ivar, ")) continue;"].join("");
        }
      }
      ...
      return ["", defPart, resultPart || '', this.tab, "for (", forPart, ") {", guardPart, varPart, body, this.tab, "}", returnResult || ''].join("");
    };
