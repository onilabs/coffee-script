(function() {
  var Access, AltPar, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, Push, Range, Return, SIMPLENUM, Scope, Slice, Splat, Suspend, Switch, TAB, THIS, Throw, Try, TryTail, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.Try = Try = (function() {
    ...
    Try.prototype.makeReturn = function() {
      ...
      if (this.tail) {
        this.tail = this.tail.makeReturn();
      }
      return this;
    };
  ...
  exports.TryTail = TryTail = (function() {
    ...
    TryTail.prototype.makeReturn = function() {
      if (this._catch) {
        this._catch = this._catch.makeReturn();
      }
      if (this._retract) {
        this._retract = this._retract.makeReturn();
      }
      return this;
    };
  ...
  exports.AltPar = AltPar = (function() {
    ...
    AltPar.prototype.makeReturn = function() {
      var block;
      if (this.combinator === 'or') {
        this.blocks = (function() {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            block = _ref2[_i];
            _results.push(block.makeReturn());
          }
          return _results;
        }).call(this);
        if (this.tail) {
  ...
  exports.Suspend = Suspend = (function() {
    ...
    Suspend.prototype.makeReturn = function() {
      this.block = block.makeReturn();
      if (this.tail) {
        this.tail = this.tail.makeReturn();
      }
      return this;
