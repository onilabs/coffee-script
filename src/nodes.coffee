...
exports.Try = class Try extends Base
  ...
  makeReturn: (res) ->
    ...
    @tail = @tail.makeReturn res if @tail
    this
...
exports.TryTail = class TryTail extends Base
  ...
  makeReturn: (res) ->
    @_catch = @_catch.makeReturn res if @_catch
    @_retract = @_retract.makeReturn res if @_retract
    this
...
exports.AltPar = class AltPar extends Base
  ...
  makeReturn: (res) ->
    if @combinator == 'or'
      @blocks = (block.makeReturn res for block in @blocks)
      @tail = @tail.makeReturn res if @tail
